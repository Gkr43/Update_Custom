		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Update Custom",
									"targetURL": "#updatecustom-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"updatecustom-display": {
								"semanticObject": "updatecustom",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=updatecustom",
									"url": sap.ui.require.toUrl("updatecustom")
								}
							}
						}
					}
